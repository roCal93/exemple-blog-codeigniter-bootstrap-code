...
<h1 class="my-4"><?= esc($new['title']); ?></h1>

<div class="article-meta mb-4">
    <em><i class="bi bi-calendar"></i> <?= ucfirst($formatter->format(strtotime($new['created_at']))); ?></em>
    <span class="ms-3"><i class="bi bi-person"></i> <?= esc($author) ?></span>
</div>
